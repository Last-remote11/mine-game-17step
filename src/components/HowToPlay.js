...
const HowToPlay = () => {
  ...
  const body = (
    <div style={modalStyle} className={classes.paper}>
      ...
      <p>0. 지뢰 게임 17보는 만화 도박묵시록 카이지에 등장하는 2인용 마작 게임입니다.</p>
      <p>1. 게임이 시작되면 자신과 상대는 동일한 점수를 걸고 자기 앞의 패산의 모든 패들(34장)을 자신 앞으로 가져옵니다.</p>
      ...
      <p>보다 자세한 룰은 이 룰의 출처이기도 한 {' '}
        <a href='https://namu.wiki/w/%EC%A7%80%EB%A2%B0%20%EA%B2%8C%EC%9E%84%2017%EB%B3%B4#s-2' target="_blank">
        나무위키</a>
        를 참고하세요</p>
    </div>
  )
